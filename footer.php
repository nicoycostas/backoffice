      ...
      <footer>
          <nav>
              ...
              <!-- replace with dynamic menu -->
                <li><a href="<?php echo get_home_url(); ?>">ARTICLES</a></li>
                <li><a href="<?php echo get_home_url(); ?>/journal">JOURNAL</a></li>
                <li><a href="<?php echo get_home_url(); ?>/note">NOTES</a></li>
                <li><a href="<?php echo get_home_url(); ?>/centralpoint">CENTRAL POINTS</a></li>
          ...
          <p>&copy; 2022 - Costas Nicou  <br/> Linux System Admin & Wordpress Web Developer</p>
      </footer>
