...
<div class="container-fluid">
    ...
    <h2 class="post_type-posts-title"><?php echo 'Decisions - ' . $term->name; // will show the name ?></h2>
    <!-- showing title of taxonomy term -->
    <div class="row">
        ...
        <div class="right-content-box col-10">
            ...
            <?php 
                  ...
                  $custom_terms = wp_get_post_terms($post->ID, 'decision_category');
