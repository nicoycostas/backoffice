<?php get_header(); ?>
    ...
    <!-- if statements to show or not show if paragraph under question is empty -->

    <!-- css correction on swot box strategy   -->

    <!-- decision implemeent best case senario, likely to happen scenario -->
