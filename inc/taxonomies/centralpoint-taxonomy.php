...
register_taxonomy('centralpoint_category', ['centralpoint'], [
    'label' => __('Categories', 'txtdomain'),
    'hierarchical' => true,
    'rewrite' => ['slug' => 'centralpoint-category'],
...
register_taxonomy_for_object_type('centralpoint_category', 'centralpoint');
