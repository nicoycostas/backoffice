...
// Register Custom Post Type decision
    function decision_post_type() {

        $labels = array(
            'name'                  => _x( 'Decision', 'Post Type General Name', 'theme_name' ),
            'singular_name'         => _x( 'Decision', 'Post Type Singular Name', 'theme_name' ),
            'menu_name'             => __( 'Decision', 'theme_name' ),
            'name_admin_bar'        => __( 'Decision', 'theme_name' ),
            'archives'              => __( 'Item Archives', 'theme_name' ),
            'attributes'            => __( 'Item Attributes', 'theme_name' ),
            'parent_item_colon'     => __( 'Parent Item:', 'theme_name' ),
            'all_items'             => __( 'All Decisions', 'theme_name' ),
            'add_new_item'          => __( 'Add New', 'theme_name' ),
            'add_new'               => __( 'Add New', 'theme_name' ),
            'new_item'              => __( 'New Item Decision', 'theme_name' ),
            'edit_item'             => __( 'Edit Decision', 'theme_name' ),
            'update_item'           => __( 'Update Decision', 'theme_name' ),
            'view_item'             => __( 'View Decision', 'theme_name' ),
            'view_items'            => __( 'View Decisions', 'theme_name' ),
            'search_items'          => __( 'Search Decisions', 'theme_name' ),
    ...
    add_action( 'init', 'decision_post_type', 0 );
