<?php
    // Register Custom Post Type decision
    function centralpoint_post_type() {

        $labels = array(
            'name'                  => _x( 'Central Point', 'Post Type General Name', 'theme_name' ),
            'singular_name'         => _x( 'Central Point', 'Post Type Singular Name', 'theme_name' ),
            'menu_name'             => __( 'Central Point', 'theme_name' ),
            'name_admin_bar'        => __( 'Central Point', 'theme_name' ),
            'archives'              => __( 'Item Archives', 'theme_name' ),
            'attributes'            => __( 'Item Attributes', 'theme_name' ),
            'parent_item_colon'     => __( 'Parent Item:', 'theme_name' ),
            'all_items'             => __( 'All Central Points', 'theme_name' ),
            'add_new_item'          => __( 'Add New Central Point', 'theme_name' ),
            'add_new'               => __( 'Add New', 'theme_name' ),
            'new_item'              => __( 'New Item Central Point', 'theme_name' ),
            'edit_item'             => __( 'Edit Central Point', 'theme_name' ),
            'update_item'           => __( 'Update Central Point', 'theme_name' ),
            'view_item'             => __( 'View Central Point', 'theme_name' ),
            'view_items'            => __( 'View Central Points', 'theme_name' ),
            'search_items'          => __( 'Search Central Points', 'theme_name' ),
        ...
        register_post_type( 'centralpoint', $args );

    }
    add_action( 'init', 'centralpoint_post_type', 0 );
