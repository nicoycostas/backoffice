...
// Register Custom Post Type decision
    function note_post_type() {
        ...
        $labels = array(
            'name'                  => _x( 'Note', 'Post Type General Name', 'theme_name' ),
            'singular_name'         => _x( 'Note', 'Post Type Singular Name', 'theme_name' ),
            'menu_name'             => __( 'Note', 'theme_name' ),
            'name_admin_bar'        => __( 'Note', 'theme_name' ),
            'archives'              => __( 'Item Archives', 'theme_name' ),
            'attributes'            => __( 'Item Attributes', 'theme_name' ),
            'parent_item_colon'     => __( 'Parent Item:', 'theme_name' ),
            'all_items'             => __( 'All Notes', 'theme_name' ),
            'add_new_item'          => __( 'Add New', 'theme_name' ),
            'add_new'               => __( 'Add New', 'theme_name' ),
            'new_item'              => __( 'New Item Note', 'theme_name' ),
            'edit_item'             => __( 'Edit Note', 'theme_name' ),
            'update_item'           => __( 'Update Note', 'theme_name' ),
            'view_item'             => __( 'View Note', 'theme_name' ),
            'view_items'            => __( 'View Notes', 'theme_name' ),
            'search_items'          => __( 'Search Notes', 'theme_name' ),
    ...
    add_action( 'init', 'note_post_type', 0 );
