...
// Register Custom Post Type Strategy
    function strategy_post_type() {
        ...
        $labels = array(
            'name'                  => _x( 'Strategy', 'Post Type General Name', 'theme_name' ),
            'singular_name'         => _x( 'Strategy', 'Post Type Singular Name', 'theme_name' ),
            'menu_name'             => __( 'Strategy', 'theme_name' ),
            'name_admin_bar'        => __( 'Strategy', 'theme_name' ),
            'archives'              => __( 'Item Archives', 'theme_name' ),
            'attributes'            => __( 'Item Attributes', 'theme_name' ),
            'parent_item_colon'     => __( 'Parent Item:', 'theme_name' ),
            'all_items'             => __( 'All Strategies', 'theme_name' ),
            'add_new_item'          => __( 'Add New', 'theme_name' ),
            'add_new'               => __( 'Add New', 'theme_name' ),
            'new_item'              => __( 'New Item Strategy', 'theme_name' ),
            'edit_item'             => __( 'Edit Strategy', 'theme_name' ),
            'update_item'           => __( 'Update Strategy', 'theme_name' ),
            'view_item'             => __( 'View Strategy', 'theme_name' ),
            'view_items'            => __( 'View Strategies', 'theme_name' ),
            'search_items'          => __( 'Search Strategy Entries', 'theme_name' ),
